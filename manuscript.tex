...
Most efforts on the estimation of a number of intelligent
   civilizations are focused on the Drake equation, although its
...
%
Here we present a statistical model for the abundance and duration of
   intelligent civilizations, implemented through Monte Carlo
   numerical simulations.
%
Using computer experiments, we explore the hypothesis space of the
   model by a suite of simulations which represent stochastic
   processes for the emergence of nodes with communication
   capabilities, and then analyze the causal connections among them.
%
...
self--replicating probes \citep[e.g.,][]{barlow_galactic_2013}, although they
would be too slow to make a significant impact on the communication
network among intelligent civilizations.
...
% 
% 
% \citet{grimaldi_signal_2017}
% \citep{balbi_impact_2018}
% \citet{cirkovic_temporal_2004}
% \citet{bloetscher_using_2019}
% \citet{smith_broadcasting_2009}
