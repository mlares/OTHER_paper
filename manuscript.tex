...
%
Reaching a first contact within the first $t_1$ years of a SETI project,
requires assuming that the methods are correct and the hypotheses of
the experiment fullfil.
%
This values can be considered as upper limits, since the efficiency of
a SETI initiative could be smaller than the ideal.
%
Also, a civilization could consider itself as "awakened" before it
discovers the right technology to perform a communication.
...
... but not in the case of different values of $\tau_s$.


%    \caption{Fraction of the CETIs that have made at least one contact  
%   as a funtion of the elapsed time since the awakening, given that they make at least one contact on their lifetime.
%   %
