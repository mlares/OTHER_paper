...
E ntity
W atch
O utlook  (the place from which an observer looks out)
L ookout  (a station or place from which a watch is kept)
A wakening (a recognition, realization, or coming into awareness of something)

CETI communicating extraterrestrial intelligence
MPL message processing location
ELI   Exposed Lookout Intelligence
EWI   Exposed Watching Intelligence
EBIL  exposed Broadcasting Intelligent lookout
EBIO  exposed Broadcasting Intelligent outlook
ISBL  Intelligent station for broadcasting and lookout
BAOS  Intelligent station for broadcasting and outlook
EBI   exposed broadcasting intelligence
OSIRIS outlook station for intelligent reception of interstellar signals
SIS    Source of intelligent signals
SLSCC source of light speed causal contact
NLCC node for lightspeec causal contact
CCN causal contact nodes
...
awakening event:
Awakening Active Activation Broadcast

contact event:
Contact Communication Connect Acquaintance Bond Link

blackout event:
Blackout Disconnect Detach Cutoff  Obscure Veil Silence Mask 

doomsday event:
Doomsday  Disappear Extinction
